...
var default_1 = /** @class */ (function (_super) {
    ...
    default_1.prototype.initializeForm = function () {
        ...
        return new Promise(function (resolve, reject) {
            if (_this.src) {
                resolve((new Form_1.default(_this.$refs.formio, _this.src, _this.options)).render()
                ...
                resolve((new Form_1.default(_this.$refs.formio, _this.form, _this.options)).render()
                    .then(function (formio) {
                    _this.formio = formio;
                    return formio;
                })
